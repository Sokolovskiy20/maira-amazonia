document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ru: {
      ...
      home_day1_desc: "Прибытие в Амазонию. Приватный лодочный трансфер вглубь диких джунглей.<br>Первый вечер в уединенном лодже у реки под тихие звуки ночного леса.<br>Глубокое погружение в атмосферу вневременного покоя великой природы.",
      
      home_day2_title: "ВГЛУБЬ ЛЕСА",
      home_day2_desc: "Утренний трекинг вглубь тропического леса под руководством экспертов.<br>Знакомство с древней целебной флорой, мхами и скрытыми микросредами.<br>Изучение вековых лесных троп и сокровенных тайн нетронутых джунглей.",
      
      home_day3_title: "РЕКА",
      home_day3_desc: "Тихая экспедиция на деревянной лодке по темным протокам черной воды.<br>Наблюдение за розовыми речными дельфинами и редкими древними птицами.<br>Встреча с гигантскими кувшинками в глубине сокрытых речных рукавов.",
      
      home_day4_title: "ГЛУБОКИЕ ДЖУНГЛИ",
      home_day4_desc: "Вход в нетронутый первобытный лес к вековым гигантским деревьям Сейба.<br>Захватывающий маршрут, позволяющий ощутить подлинный масштаб природы.<br>Соприкосновение с величественными исполинами древнего влажного леса.",
      
      home_day5_title: "НАБЛЮДЕНИЕ С ВЫСОТЫ",
      home_day5_desc: "Подъем на 45-метровую платформу над пологом тропического леса на заре.<br>Панорамный вид на бескрайний океан изумрудных крон до самого горизонта.<br>Ощутите первозданную тишину и величие утренних реликтовых джунглей.",
      
      home_day6_title: "НОЧНАЯ ЭКСПЕДИЦИЯ",
      home_day6_desc: "Ночная вылазка на речных шлюпках под таинственный полог дикого леса.<br>Поиск черных кайманов, биолюминесцентных мхов и ночных обитателей.<br>Погружение в завораживающую ночную симфонию первозданной природы.",
      
      home_day7_title: "ПЛАВУЧИЙ ЛАГЕРЬ",
      home_day7_desc: "Размещение в уединенном плавучем эколагере на зеркальной глади реки.<br>Спокойный сон под мягкий и умиротворяющий ритм древнего течения вод.<br>Абсолютная тишина и гармоничное слияние с дикой природой Амазонии.",
      ...
      home_day10_desc: "Финальный утренний круиз по величественной реке обратно к Манаусу.<br>Панорамный полет на гидросамолете над слиянием двух великих рек.<br>Возвращение домой с вечной тишиной и силой Амазонии в своем сердце.",
